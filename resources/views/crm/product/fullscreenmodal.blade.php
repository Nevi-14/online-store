<!-- Modal -->
<div class="modal left  fade" id="exampleModalPreview" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h6 class="modal-title text-info text-uppercase text-bold">New Product</h6>

        <button type="button" class="btn btn-danger btn-sm rounded-pill" data-dismiss="modal" aria-label="Close">
          Close
        </button>
      </div>
