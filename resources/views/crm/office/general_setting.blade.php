                        ...
                        <div class="card-body bg-light-gray pb-5">
                          @csrf
                            ...
                            <div class="row">
                              ...
                              <div class="col-12">
                                <div class="form-group">
                                  <label><span class="text-danger"> </span>{{__('About')}} </label>
                                  <div class="input-group">
                                   <textarea name="company_about" class="form-control form-control-sm" cols="30" rows="6">{{@$company_about->field_value}}</textarea>
                                  </div>
                                </div>
                              </div>
                            </div>
                  ...
                  <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body  bg-light-gray">
                          ...
                          <img class="d-inline-block align-top" src= "/show_company_images/?file={{@$logo->field_value}}" alt="Card image cap" height="105" width="105">
                          </div>
                            <div class="col-md-6">
                              <div class="form-group">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body bg-light-gray">
                                  @csrf
                                    ...
                                    <div class="form-group">
                                      <div class="input-group">
                                          <textarea name="terms" id="" cols="30" rows="7"  class="form-control form-control-sm" required>{{@$terms->field_value}}</textarea>
                                      </div>
                                    </div>
