            ...
            <div class="col-md-9">
              <div class="card-body">
                ...
                @php
                    $url = url('form/'.$token);
                @endphp
                <code class="text-secondary bg-transparent">{{ '<iframe style="width:100%; height:auto;overflow:auto;"  src="'.$url.'" frameborder="0" allowfullscreen></iframe>' }}
                </code>
                <br />
                <br />
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            <form action="{{url('lead/webform', $token)}}" method="post">
                              <h3 id="showheading" class="text-title"></h3>
                              <p id="shownote"></p>
                          <div class="container">
