		...
		<section class="content">
				...
				<div class="container-fluid">
						...
						<div class="row">
								...
								<button type="button" class="btn btn-primary btn-sm mb-1" id="addButton">{{__('Add New Reminder')}}</button>

									<button type="button" class=" btn btn-secondary btn-sm mb-1 d-hide" id="hideButton"> {{__('Hide Reminder Window')}}</button>

									<div class="card d-hide bg-light-gray mt-2" id="new_task_card">
                  ...
                  <span ><span class="text-danger"></span> {{__('Timezone ')}}</span>

                  <div class="input-group">

                      <select name="timezone" id="timezone" class="select2 form-control form-control-sm" data-validation="required" required >
						...
						<option value="{{$timezone->id}}">{{$timezone->name}}   {{$timezone->utc}}</option>
                  ...
                  <div class="input-group">
                      ...
                      <select name="timezone" class="select2 form-control form-control-sm" data-validation="required" required >
