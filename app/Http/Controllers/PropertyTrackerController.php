...
return datatables()->of($data)
                ...
                ->addColumn('action', function ($lead) {
                    ...
                    $button = '<a class="mr-2 btn btn-sm btn-primary rounded-pill text-white" href=' . $edit_url . '>
                                <i class="fas fa-edit mx-1"></i> ' . __("Edit") . '
                            </a>';
                    $button .= '&nbsp;&nbsp;';
              ...
              if($user_id == 1){
                ...
                $button .= '<a href="#" class="btn btn-sm btn-danger rounded-pill  text-white" onclick="confirmDelete(' . $lead->id . ')">
                <i class="fas fa-trash mx-1"></i> ' . __('Delete') . ' 
            </a>';
    ...
    public function update(Request $request, propertyTracker $propertyTracker , Validator $validator)
    {
     ...
     if( $propertyTracker->stage == 'Prospect'){
      /** LEAD INFORMATION **/
      $propertyTracker->update([
        'stage' =>'Opportunity',
