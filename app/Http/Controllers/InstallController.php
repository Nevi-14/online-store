 ...
 *         if(!$request->purchase_code){
        ...
        $response = InstallService::callAPI($purchase_code);
...
// error_log(Artisan::output());
    public function save_install_final(Request $request){
        ...
        $installed = 'Software  installed at '.now().' Do not delete this file, it prevents the users to run the installer again!'; 
