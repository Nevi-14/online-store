...
class GeneralSettingsController extends Controller
{
    public function index()
    {
        ...
        $company_about = SingleRowData::where('field_name','company_about')->first();
    ...
    public function storeDetails(Request $request)
    {
       ...
       SingleRowData::create([
        ...
        SingleRowData::create([
            'field_name'=>'company_about',
            'field_type'=>'text',
            'field_value'=>$request->company_about
            ,
        ]);
    ...
    public function updateDetails(Request $request, $company_name)
    {
        ...
        $company_about = SingleRowData::where('field_name','company_about')->first();
        $company_about->field_value = $request->company_about;
        $company_about->save();
    ...
    public function showCompanyImage(Request $request)
    {
        if (Storage::disk('public')->exists("adminfiles/companies/$request->file")) {
            $path = Storage::disk('public')->path("adminfiles/companies/$request->file");
